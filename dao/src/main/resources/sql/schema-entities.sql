...
CREATE TABLE IF NOT EXISTS scheduler (
    id UUID NOT NULL CONSTRAINT scheduler_key PRIMARY KEY,
    name VARCHAR(255),
    configuration JSONB,
    type VARCHAR(50) NOT NULL,
    enable boolean,
...
CREATE TABLE IF NOT EXISTS entity_group (
    id UUID NOT NULL CONSTRAINT entity_group_key PRIMARY KEY,
    name VARCHAR(255),
    description VARCHAR(255),
    type VARCHAR(50) NOT NULL,
    tenant_id UUID NOT NULL,
    user_id_generated UUID NOT NULL,
    user_id_affected UUID ,
    created_time BIGINT NOT NULL,
    version BIGINT DEFAULT 1
);
CREATE TABLE IF NOT EXISTS entity_group_relation (
    id UUID NOT NULL CONSTRAINT entity_group_relation_key PRIMARY KEY,
    entity_id UUID NOT NULL,
