...
public interface AssetDao extends Dao<Asset>, TenantEntityDao<Asset>, ExportableEntityDao<AssetId, Asset> {
    ...
    /**
     * Find asset infos by tenantId , user and page link.
     *
     * @param tenantId the tenantId
     * @param userId the tenantId
     * @param pageLink the page link
     * @return the list of asset info objects
     */
    PageData<AssetInfo> findAssetInfosByTenantUserId(UUID tenantId, UUID userId ,  PageLink pageLink);
