...
public class ModelConstants {
    ...
    public static final String USER_STATUS_PROPERTY = "status";
    ...
    public static final String ENTITY_GROUP_USER_ID_AFFECTED = "user_id_affected";
    public static final String ENTITY_GROUP_USER_ID_GENERATED = "user_id_generated";
    public static final String ENTITY_GROUP_RELATION_TABLE_NAME = "entity_group_relation";
    public static final String ENTITY_GROUP_RELATION_ENTITYID = "entity_id";
    public static final String ENTITY_GROUP_RELATION_GROUPID = "group_id";
    ...
    public static final String USER_SCHEDULER_USER_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String SCHEDULER_USER_ID_PROPERTY = USER_ID_PROPERTY;

    public static final String SCHEDULER_NAME_PROPERTY = "name";
    public static final String SCHEDULER_TYPE_PROPERTY = "type";
    public static final String SCHEDULER_CONFIGURATION_PROPERTY = "configuration";
    public static  final  String SCHEDULER_TIME_PROPERTY = "scheduler";
    ...
    public static final String CALCULATED_FIELD_USER_ID_COLUMN = USER_ID_PROPERTY;
    ...
    public static final String CALCULATED_FIELD_STATUS = "status";
