...
public class CalculatedFieldEntity extends BaseVersionedEntity<CalculatedField> implements BaseEntity<CalculatedField> {
    ...
    @Column(name = CALCULATED_FIELD_USER_ID_COLUMN)
    private UUID userId;
    ...
    @Column(name = CALCULATED_FIELD_STATUS)
    ...
    public CalculatedFieldEntity(CalculatedField calculatedField) {
        ...
        this.userId = calculatedField.getUserId().getId();
        ...
        this.status = calculatedField.isStatus();
    ...
    public CalculatedField toData() {
        ...
        calculatedField.setUserId(new UserId(userId) );
        ...
        calculatedField.setStatus(status);
