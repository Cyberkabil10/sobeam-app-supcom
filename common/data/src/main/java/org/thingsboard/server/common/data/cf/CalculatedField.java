...
@EqualsAndHashCode(callSuper = true)
    ...
    public CalculatedField(TenantId tenantId, UserId userId,EntityId entityId, CalculatedFieldType type,  boolean status ,String name, int configurationVersion, CalculatedFieldConfiguration configuration, Long version) {
    ...
    public CalculatedField(CalculatedField calculatedField) {
        ...
        this.userId = calculatedField.userId;
        this.entityId = calculatedField.entityId;
        this.type = calculatedField.type;
        this.status = calculatedField.status;
