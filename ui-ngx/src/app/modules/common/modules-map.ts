...
import * as SchedulerDataComponent from '@home/components/scheduler/scheduler-data.component';
...
class ModulesMap implements IModulesMap {
  ...
  private modulesMap: {[key: string]: any} = {
    ...
    '@home/components/scheduler/scheduler-data.component': SchedulerDataComponent,
