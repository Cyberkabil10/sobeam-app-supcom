...
import { CountryData, CountryISO } from '@shared/models/country.models';
...
export class CustomerComponent extends ContactBasedComponent<Customer> {
  ...
  constructor(protected store: Store<AppState>,
    ...
    this.entityForm.addControl('groupId', this.fb.control(''));
    if(this.authUser?.status === false){
      this.entityForm.get('groupId').setValidators([Validators.required]);
    }
    this.entityForm.get('groupId').updateValueAndValidity();
  }
