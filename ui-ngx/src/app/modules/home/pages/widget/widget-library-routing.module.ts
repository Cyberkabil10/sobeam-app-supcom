...
import { detailsToWidgetInfo, WidgetInfo } from '../../models/widget-component.models';
import {
...
import { WidgetTypesTableConfigResolver } from '../widget/widget-types-table-config.resolver';
