...
import { EntityDialogData, TbManageGroupsDialogComponent } from '@app/shared/components/dialog/tb-manage-groups-dialog/tb-manage-groups-dialog.component';
...
export class DevicesTableConfigResolver {
 ...
 authUser: any;
  ...
  assignToGroup($event: Event, deviceIds: Array<DeviceId>) {
    if ($event) {
      $event.stopPropagation();
    }
