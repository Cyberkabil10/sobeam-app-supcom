...
export class DeviceProfileComponent extends EntityComponent<DeviceProfile> {
    ...
    const form = this.fb.group(
      {
        ...
        profileData: this.fb.group({
          ...
          declarationConfiguration: [entity && !this.isAdd ? entity.profileData?.declarationConfiguration : null]
        }),
  ...
  updateForm(entity: DeviceProfile) {
    ...
    this.entityForm.patchValue({profileData: {
      ...
      declarationConfiguration: entity.profileData?.declarationConfiguration
    }}, {emitEvent: false});
