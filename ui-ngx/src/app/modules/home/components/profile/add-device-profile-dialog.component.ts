...
export class AddDeviceProfileDialogComponent extends
  ...
  declarationConfigFormGroup: UntypedFormGroup;
  ...
  constructor(protected store: Store<AppState>,
    ...
    this.declarationConfigFormGroup = this.fb.group(
      {
        declarationConfiguration: [null]
      }
    );
  ...
  selectedForm(): UntypedFormGroup {
    switch (this.selectedIndex) {
      ...
      case 4:
        return this.declarationConfigFormGroup;
    }
  }
    ...
    if (this.allValid()) {
      ...
      const deviceProfile: DeviceProfile = {
        ...
        profileData: {
          ...
          declarationConfiguration: this.declarationConfigFormGroup.get('declarationConfiguration').value
        }
      };
  ...
  getFormLabel(index: number): string {
    switch (index) {
      ...
      case 4:
        return 'device-profile.device-declation';
    }
  }
