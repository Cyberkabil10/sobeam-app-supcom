...
@Component({
  selector: 'tb-scheduler-data',
  templateUrl: './scheduler-data.component.html',
  styleUrls: ['./scheduler-data.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SchedulerDataComponent),
      multi: true
    }
  ]
})
export class SchedulerDataComponent implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.aliasFilterTypes = ["singleEntity"];
