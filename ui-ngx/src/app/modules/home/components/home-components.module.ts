...
import { SchedulerDataComponent } from './scheduler/scheduler-data.component';
import { TbProfilDeclaraionComponent } from './profile/tb-profil-declaraion.component';
...
@NgModule({
  declarations:
    [
      ...
      CalculatedFieldTestArgumentsComponent,
      EntityChipsComponent,
      SchedulerDataComponent,
      TbProfilDeclaraionComponent
    ],
  imports: [
    CommonModule,
    SharedModule,
