...
export const defaultMobilePageMap = new Map<MobileMenuPath, Omit<DefaultMobilePage, 'type' | 'visible'>>([
  ...
  [
    MobileMenuPath.NOTIFICATIONS,
    {
      ...
      label: 'mobile-menu.notifications'
    }
  ]
])
