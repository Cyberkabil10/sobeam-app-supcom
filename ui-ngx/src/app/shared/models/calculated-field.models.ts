...
export enum CalculatedFieldTypeV2 {
  SIMPLE = 'SIMPLE',
}

export const CalculatedFieldTypeTranslations = new Map<any, string>(
  [
...
export const ActionTypeTranslations = new Map<ActionType, string>(
  [
    [ActionType.SendRpc, 'calculated-fields.send-rpc'],
    [ActionType.UpdateAttribute, 'calculated-fields.update-attribute'],
    [ActionType.sendNotification, 'calculated-fields.send-notification'],
    [ActionType.SendEmail, 'calculated-fields.send-email'],
    [ActionType.SendSms, 'calculated-fields.send-sms'], 
  ]
)
