  ...
  [
    ...
    [
      EntityType.GROUP,
      {
        ...
        typePlural: 'entity.type-groups',
        list: 'entity.list-of-groups',
        nameStartsWith: 'entity.group-name-starts-with',
        details: 'group.group-details',
        add: 'group.add',
        noEntities: 'group.no-groups-text',
        search: 'group.search',
        selectedEntities: 'group.selected-groups'
      }
    ],
    [
      EntityType.SCHEDULER,
      {
        type: 'entity.type-scheduler',
        typePlural: 'entity.type-scheduler',
        list: 'entity.list-of-scheduler',
        nameStartsWith: 'entity.scheduler-name-starts-with',
        details: 'scheduler.scheduler-details',
        add: 'scheduler.add',
        noEntities: 'scheduler.no-scheduler-text',
        search: 'scheduler.search',
        selectedEntities: 'scheduler.selected-scheduler'
      }
    ],
    [
...
export const baseDetailsPageByEntityType = new Map<EntityType, string>([
  ...
  [EntityType.SCHEDULER, '/schedulers'],
