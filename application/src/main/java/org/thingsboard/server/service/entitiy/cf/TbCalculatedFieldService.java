...
public interface TbCalculatedFieldService {
    ...
    PageData<CalculatedField> findAllByTenant(TenantId entityId, PageLink pageLink);

    PageData<CalculatedField> findAllByUser(TenantId entityId, UserId userId, PageLink pageLink);
