...
import static org.thingsboard.server.common.data.id.TenantId.fromUUID;
...
public class DefaultTbTenantService extends AbstractTbEntityService implements TbTenantService {
    ...
    @Override
    public boolean findTenantById(String tenantId) {
        Tenant tenant = tenantService.findTenantById(new TenantId(UUID.fromString(tenantId)));
