...
public class TbMsgGeneratorNodeConfiguration implements NodeConfiguration<TbMsgGeneratorNodeConfiguration> {
    ...
    public static class TbSchedulerNodeConfiguration implements NodeConfiguration {
        ...
        // Depending on ThingsBoard version, you might need to override additional methods.
    }
}
